...
export const Button: FC<ButtonProps> = ({
  ...
  const mode =
    variant === "primary"
      ? "text-white bg-primary-700 hover:bg-primary-900 py-2 rounded-md hover:shadow-md active:shadow-sm active:bg-primary-800 active:text-white border border-1 border-primary-600"
