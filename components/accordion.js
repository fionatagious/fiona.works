...
export default function SkillsAccordion() {
  ...
  const skillsData = [
    { name: "Languages", children: ['HTML5', 'CSS3', 'Javascript', 'SQL', 'TypeScript', 'Ruby', 'Python', 'SAS', 'R'],},
    { name: "Frameworks", children: ['Tailwind', 'Bootstrap', 'Next.js', 'React', 'Ruby on Rails', 'Material UI'],},
    { name: "Tools", children: ['Jest', 'Rspec', 'Capybara', 'Sidekiq', 'Logz.io', 'Honeybadger', 'SendGrid'],},
    { name: "Soft skills", children: ['Attention to detail', 'Communication', 'Curiosity', 'Dedication', 'Empathy ', 'Organization'],},
  ];
