  ...
  return (
    <div className="mx-4">
      <Grid item xs={12} className="grid content-center">
        <div className="animate-fade text-left text-mauve font-bold font-mono text-xl sm:text-2xl mb-2 mt-4">
          Hello! My name is
        </div>
        <div className="animate-fade font-extrabold text-left text-slate-600 text-4xl sm:text-7xl my-3">
          Fiona Tang
        </div>
      </Grid>
      <Grid item xs={12} md={8} lg={6} className="grid content-start mb-4">
        <div className="animate-fade text-left text-slate-950 text-lg sm:text-xl my-2 mb-6">
