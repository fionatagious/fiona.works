...
export default function Overview() {
  return (
    <Card sx={{ minWidth: 275, maxWidth: 1200, marginTop: '1.2rem', marginBottom: '15px', backgroundColor: 'hsla(0, 100%, 0%, 0.7)' }}>
      <CardContent>
        ...
        <Typography variant="body2" className={utils.descriptionText}>
          📫&nbsp;&nbsp;Write to me at <a href="mailto: fionatang@alum.berkeley.edu" className={utils.email}>fionatang@alum.berkeley.edu</a>.
        </Typography>
      </CardContent>
    </Card>
  );
