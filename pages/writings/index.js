    ...
    <Grid container className="px-0 4xl:px-4 py-4">
      ...
      >
        {articles.map((child) => (
          <div
            key={child.id}
            className="media text-left text-sm sm:text-lg text-mauve min-w-[212px] w-[340px] sm:w-[200px] my-1 mx-1 p-5 border rounded-md border-gray-400 hover:border-slate-950 bg-white hover:cursor-pointer hover:translate-y-[-2px]"
            onClick={() => {
