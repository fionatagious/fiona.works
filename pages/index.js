...
export default function Home() {
  return (
    <div className="mx-0 bg-indigo-950">
      ...
      <Grid
        container
        className="flex flex-col min-h-1/2 px-4 lg:px-32 pt-6 sm:pt-32"
      >
        <Intro />
        <Grid item xs={12} className="px-0 lg:px-32 py-20 my-20">
        ...
        <Grid item xs={12} className="px-0 lg:px-32 pt-20 mt-20">
          <div className="heading text-slate-400 font-bold text-md text-center sm:text-left text-2xl sm:text-3xl m-4">
            Written Works
          </div>
          <Writings />
